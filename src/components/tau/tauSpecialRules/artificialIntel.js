    ...
    return (
      <Container>
        <Row className="ability">
          <Col xs="3">Artificial Intelligence</Col>
          <Col xs="9">
            <ul>
              <li>
              ...
              <li>
                For the purpose of determining control of objective
                markers,treat this operative's APL as 1 lower.
              </li>
              <li>
                Each time a shooting attack is made against this operative, in
                the Roll Defence Dice step of that shooting attack, if it has an
              ...
              <li>
                Unless otherwise specified, this operative cannot be equiped
                with equipment.
              </li>
            </ul>
          </Col>
