...
class MarkerLight extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Col className="ability">Markerlight (1AP)</Col>
        <Col>
          <p>
            ...
            this action if it is within Engagement Range of an enemy operative.
            If an operative would perform this action and a SHOOT action in the
            same activation, only the target of that SHOOT actions shooting
            attack can be selected for this action.
          </p>
          <p>
            Operatives gain Markerlight tokens as explained above. In the ready
            operatives step of the Initiative Phase, remove one Markerlight
            Token that each operative has.
          </p>
          <p>
            Each time an operative makes a shooting attack it gains a number of
            cumulative benefits for that shooting attack depending on how many
            Markerlight tokens the target operative has. Operatives gain no
            markerlight benefits for shooting attacks made with EMP and Fusion
            grenades
          </p>
          <ol>
            <li>
            ...
            <li>
              2+ For that shooting attack, the active operative's ranged weapons
              gain the{" "}
