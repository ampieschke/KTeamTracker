      ...
      <Container>
        <Row className="ability">
          ...
          <Col xs="9">
            ...
            <ul>
              <li>
                Mont'Ka - Each time a friendly Pathfinder operative is
                activated, if it has an Engage order for that activation, it can
                perform a free DASH action during that activation{" "}
              </li>
              <li>
